...
/**
 * This file was automatically generated by EvoMaster on 2020-12-05T12:00:27.985+01:00[Europe/Paris]
 * <br>
 * The generated test suite contains 672 tests
 * <br>
 * Covered targets: 6518
 * <br>
 * Used time: 24h 0m 0s
 * <br>
...
public class EvoMasterTest_24h_seed_10_per_op {
        ...
        try{
            given().accept("*/*")
                    .get(baseUrlOfSut + "/users/count/density/groupBy/boundary?" + 
                        "bcircles=cPMYk%3A8.729%2C49.410%2C92&" + 
                        "filter=destination%21%3D*+or+geometry%3Apolygon+or+area%3A%281.0+..+1E6%29&" + 
                        "time=%2F%2FP3Y11D")
                    .then();
        } catch(Exception e){
        }
    ...
    public void test_10_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/groupBy/type?" + 
                    "bcircles=8.700%2C49.403%2C4%7C8.70075%2C49.436%2C1%7C8.747%2C49.4015%2C6%7C8.717%2C49.4.7260%2C23&" + 
                    ...
                    "format=evomaster_1939292_input&" + 
                    "keys=highway&" + 
                    "showMetadata=no&" + 
                    "time=3%2FP1M4D&" + 
                    "timeout=24")
    ...
    public void test_20_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bpolys=ea%3A8.704561%2C49.403252%2C8.70775%2C49.4397%2C8.708%2C49.41813%2C8.708%2C49.43480%2C8.704561%2C49.403252%7CSQD%3A8.704561%2C49.403252%2C8.726%2C49.400%2C8.70465%2C49.402%2C8.749%2C49.414%2C8.704561%2C49.403252%7CF%3A8.704561%2C49.403252%2C8.7229%2C49.421634%2C8.7070%2C49.437%2C8.704%2C49.419%2C8.704561%2C49.403252&" + 
                    "keys=highway&" + 
                    "time=%2F%2FP10M18D&" + 
                    "timeout=70")
                .then()
                ...
                .body("'status'", numberMatches(500.0))
                .body("'error'", containsString("Internal Server Error"))
                .body("'message'", containsString("found non-noded intersection between LINESTRING ( 8.704561 49.403252, 8.70775 49.4397 ) and LINESTRING ( 8.708 49.4348, 8.704561 49.403252 ) [ (8.704561, 49.403252, NaN) ]"))
                .body("'path'", containsString("/users/count/groupBy/boundary"));
    }
    ...
    public void test_81_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/length/groupBy/type?" + 
                    "bcircles=TiuFC%3A8.739%2C49.40.108%2C3%7ChG%3A8.70665%2C49.424%2C8&" + 
                    "keys=evomaster_2157269_input&" + 
                    "types=foo")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_114_createCircularPolygons
                .assertThat()
    ...
    public void test_86_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/length/groupBy/key?" + 
                    "bcircles=dZ%3A8.728%2C49.4378%2C1%7CR%3A8.70.451%2C49.435%2C6%7Cl%3A8.712118%2C49.41135%2C82&" + 
                    "filter=foo&" + 
                    "format=foo&" + 
                    "groupByKeys=foot%2Cbicycle%2Csidewalk&" + 
                    "keys=evomaster_1423671_input&" + 
                    "time=foo")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_114_createCircularPolygons
                .assertThat()
    ...
    public void test_112_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/ratio?" + 
                    "bboxes=x%3A8.665%2C49.4010%2C8.73.7%2C49.394&" + 
                    "filter2=foo&" + 
                    "format=json&" + 
                    "keys=foo&" + 
                    "keys2=evomaster_926963_input&" + 
                    "showMetadata=foo&" + 
                    "time=2017-0UU2U&" + 
                    "timeout=46&" + 
                    "types=foo&" + 
    ...
    public void test_117_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/groupBy/tag?" + 
                    "bcircles=8.7339%2C29.4.84%2C80&" + 
                    "filter=foo&" + 
                    "format=foo&" + 
                    "groupByKey=higdwayd&" + 
                    "keys=evomaster_2131988_input&" + 
                    "showMetadata=evomaster_2132116_input&" + 
                    "time=2016-06-18&" + 
                    "timeout=49")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_114_createCircularPolygons
    ...
    public void test_129_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/density/groupBy/tag?" + 
                    "bcircles=lYOmS%3A8.74695%2C49.425.60%2C45%7Cv%3A8.736%2C49.407%2C5&" + 
                    "groupByKey=building&" + 
                    "groupByValues=karage&" + 
                    "keys=foo&" + 
                    "time=2011%2C06-02&" + 
                    "timeout=0.5202271287868178&" + 
                    "types=foo")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_114_createCircularPolygons
                .assertThat()
    ...
    public void test_130_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/density/groupBy/tag?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22featureu%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22hiKI%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.705665%2C49.411%5D%2C%5B8.742%2C49.4244%5D%2C%5B8.700%2C49.4377%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "filter=evomaster_1437960_input&" + 
                    "format=cs&" + 
                    "groupByKey=evomaster_1437959_input&" + 
                    "groupByValues=street_lamp%2Csynagogue%2Ccommercial&" + 
                    "showMetadata=evomaster_1437961_input&" + 
                    "values=secondary")
                .then()
    ...
    public void test_134_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/density/groupBy/boundary/groupBy/tag?" + 
                    "bpolys=8.704561%2C49.403252%2C8.715%2C49.412%2C8.724%2C49.427%2C8.704911%2C49.407%2C8.704561%2C49.403252%7C8.704561%2C49.403252%2C8.743%2C49.426%2C8.707%2C49.417%2C8.742%2C49.416%2C8.704561%2C49.403252&" + 
                    "filter=lanes%3Aforward%21%3D*+or+type%3Away+and+not+length%3A%28+..+100%29&" + 
                    "groupByKey=highway&" + 
                    "groupByValues=speed_camera%2Cschool%2Chotel&" + 
                    "keys=highway&" + 
                    "timeout=88")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/InputProcessor_224_processParameters
                ...
                .body("'status'", numberMatches(500.0))
                .body("'error'", containsString("Internal Server Error"))
                .body("'message'", containsString("found non-noded intersection between LINESTRING ( 8.704561 49.403252, 8.715 49.412 ) and LINESTRING ( 8.704561 49.403252, 8.743 49.426 ) [ (8.704561, 49.403252, NaN) ]"))
                .body("'path'", containsString("/elements/count/density/groupBy/boundary/groupBy/tag"));
    }
    ...
    public void test_144_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/ratio?" + 
                    "bcircles=V%3A8.7.024%2C49.4170%2C8&" + 
                    "filter=foo&" + 
                    "keys2=floating&" + 
                    "showMetadata=no&" + 
                    "time=2017-07-26&" + 
    ...
    public void test_163_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density/groupBy/tag?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22a%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.725%2C49.4085%5D%2C%5B8.7274%2C49.435%5D%2C%5B8.746%2C49.4382%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22fJ%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.706%2C49.408%5D%2C%5B8.739%2C49.428%5D%2C%5B8.74709%2C49.402%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "format=csv&" + 
                    "groupByKey=highway&" + 
                    "time=2016-12-11&" + 
                    "timeout=99")
                ...
                .body("'status'", numberMatches(500.0))
                .body("'error'", containsString("Internal Server Error"))
                .body("'message'", containsString("found non-noded intersection between LINESTRING ( 8.726055535390199 49.420154869933455, 8.7274 49.435 ) and LINESTRING ( 8.746 49.4382, 8.7208942774203 49.41702683480018 ) [ (8.72617563023147, 49.42148091713916, NaN) ]"))
    ...
    public void test_175_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22jiO%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.705%2C49.422%5D%2C%5B8.719%2C49.4069%5D%2C%5B8.706%2C49.402%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22foIc%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.707542%2C49.423%5D%2C%5B8.7041%2C49.416%5D%2C%5B8.709%2C49.4061%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22Sk%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.748%2C49.413%5D%2C%5B8.749%2C49.40428%5D%2C%5B8.705%2C49.401%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "filter=network%21%3D*+or+area%3A%281.0+..+1E6%29&" + 
                    "format=evomaster_347_input&" + 
                    "types=foo&" + 
                    "values=foo")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_303_unifyPolys
                ...
                .body("'status'", numberMatches(500.0))
                .body("'error'", containsString("Internal Server Error"))
                .body("'message'", containsString("found non-noded intersection between LINESTRING ( 8.704561 49.403252, 8.707056262713264 49.41978217378784 ) and LINESTRING ( 8.704825196312699 49.41453480744985, 8.709 49.4061 ) [ (8.705927865213882, 49.41230696620052, NaN) ]"))
                .body("'path'", containsString("/elements/count"));
    }
    ...
    public void test_176_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22LZBRd%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.741%2C49.4319%5D%2C%5B8.7498%2C49.439242%5D%2C%5B8.7486%2C49.4197%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22X%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.7102%2C49.413%5D%2C%5B8.704538%2C49.43390%5D%2C%5B8.704%2C59.403%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "format=csv&" + 
                    "keys=evomaster_25065_input&" + 
                    "showMetadata=foo&" + 
                    "timeout=56&" + 
                    "values=track")
                .then()
                ...
                .body("'status'", numberMatches(500.0))
                .body("'error'", containsString("Internal Server Error"))
                .body("'message'", containsString("found non-noded intersection between LINESTRING ( 8.7102 49.413, 8.704538 49.4339 ) and LINESTRING ( 8.704 59.403, 8.704561 49.403252 ) [ (8.704559285011694, 49.43382143116489, NaN) ]"))
                .body("'path'", containsString("/elements/area/density"));
    }
    ...
    public void test_177_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=8.719.31%2C59.828%2C7s&" + 
                    "filter=addr%3Ahousenumber%21%3D*+and+type%3Anode%1Fand+not+area%3A%281.0+..+1E6%29&" + 
                    "keys=evomaster_36064_input&" + 
                    "showMetadata=&" + 
                    "time=evomaster_62961_input&" + 
                    "timeout=31&" + 
                    "types=evomaster_62962_input&" + 
                    "values=evomaster_16980_input")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_114_createCircularPolygons
                .assertThat()
                .contentType("application/json")
    ...
    public void test_179_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/density/groupBy/tag?" + 
                    "bboxes=UM%3A8.6822%2C49.416%2C8.73304.%2C49.382%7CMe%3A8.681%2C49.415%2C8.735244%2C49.386%7CokE%3A8.6717%2C49.420%2C8.709%2C49.39807%7Cy%3A8.656089%2C49.421%2C8.7041%2C49.397063&" + 
                    "format=geojson&" + 
                    "groupByKey=evomaster_20229_input&" + 
                    "groupByValues=foo")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_65_createBboxes
                .assertThat()
    ...
    public void test_180_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/groupBy/key?" + 
                    "bcircles=V%3A8.746379%2C49.4.74%2C5335784%2F4&" + 
    ...
    public void test_181_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density?" + 
                    "bpolys=%7B%22typc%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22LZBRd%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.741%2C49.4319%5D%2C%5B8.7498%2C49.439242%5D%2C%5B8.7486%2C49.4197%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22X%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Pol%C2%81gon%22%2C%22coordinates%22%3A%5B%5B%5B8.704563%2C49.403252%5D%2C%5B8.7102%2C49.413%5D%2C%5B8.704538%2C49.43390%5D%2C%5B8.704%2C49.403%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "filter=evomaster_31927_input&" + 
                    "format=cSV&" + 
                    "time=foo&" + 
                    "types=fo&" + 
                    "values=0sZP")
    ...
    public void test_182_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/groupBy/key?" + 
                    "bpolys=sBbKS%3A8.7245%3A1%2C49.403252%2C8.724%2C49.41548.%2C8%2F704560%2C49.410907%2C8.7206%2C49.4285%2C8.704561%2C49.403251&" + 
                    "format=evomaster_517121_input&" + 
                    "groupByKeys=evXQcsterc87U6_inUU&" + 
                    "showMetadata=evomaster_520083_input&" + 
                    "types=Ai5kVDXdIt9T&" + 
                    "values=foo")
                .then()
    ...
    public void test_183_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/density/groupBy/boundary/groupBy/tag?" + 
                    "bcircles=fk%3A8.706%2C49.40149%2C7%7CPE%3A8.71.544%2C49.40520%2C6&" + 
                    "filter=foo&" + 
                    "format=csv&" + 
                    "groupByKey=evomaster_93360_input&" + 
                    "keys=highway&" + 
                    "time=evomaster_534457_input&" + 
                    "values=secondary_link")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_114_createCircularPolygons
                .assertThat()
    ...
    public void test_184_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22fe%60tures%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22LZBRd%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.741%2C49.4319%5D%2C%5B8.7498%2C49.439242%5D%2C%5B8.7486%2C49.4197%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22X%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704563%2C49.403252%5D%2C%5B8.7102%2C49.413%5D%2C%5B8.704538%2C49.43390%5D%2C%5B8.704%2C49.403%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "filter=evomaster_31927_input&" + 
                    "format=Csv&" + 
                    "keys=evomaster_24502_input&" + 
                    "showMetadata=evomaster_53242_input&" + 
                    "time=VOAu&" + 
                    "types=evomaster_53243_input&" + 
                    "values=evomaster_297756_input")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_237_createGeometryFromGeoJson
                .assertThat()
                .contentType("application/json")
    ...
    public void test_185_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/groupBy/type?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22f%22%7D%2C%22gemmetry%22%3A%7B%22type%22%3A%22MvlrgUo%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.733%2C49.4314%5D%2C%5B8.731%2C49.400%5D%2C%5B8.7065%2C49.4264%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22CBv%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.73065%2C49.435%5D%2C%5B8.704%2C49.41221%5D%2C%5B8.704590%2C49.4040%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22k%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.730%2C49.4021%5D%2C%5B8.71670%2C49.412%5D%2C%5B8.71467%2C49.430%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "filter=7neVQcO_x7%3AJXN4X&" + 
                    "format=cSV&" + 
                    "timeout=100&" + 
                    "types=igo8")
                .then()
    ...
    public void test_186_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count?" + 
                    "bcircles=8.7.9%2C49.413%2C6%7C8.732%2C49.418%2C33&" + 
                    "filter=foo&" + 
                    "format=csv&" + 
                    "keys=hichway&" + 
                    "time=%2F7P26D&" + 
    ...
    public void test_187_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/groupBy/type?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22featutes%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22f%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polyg_n%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.733%2C49.4314%5D%2C%5B8.731%2C49.400%5D%2C%5B8.7065%2C49.4264%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22CBv%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.73065%2C49.435%5D%2C%5B8.704%2C49.41221%5D%2C%5B8.704590%2C49.4040%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22k%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.730%2C49.4021%5D%2C%5B8.71670%2C49.412%5D%2C%5B8.71467%2C49.430%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "filter=evoUqstUr_501UU00oin%60u&" + 
                    "format=evomaster_1018479_input&" + 
                    "showMetadata=true&" + 
                    "time=foo&" + 
                    "timeout=100&" + 
                    "types=foo&" + 
                    "values=evomaster_1017449_input")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_237_createGeometryFromGeoJson
                .assertThat()
                .contentType("application/json")
    ...
    public void test_188_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/groupBy/type?" + 
                    "bpolys=%7B%22typd%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22f%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Pqlyg_n%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.733%2C49.4314%5D%2C%5B8.731%2C49.400%5D%2C%5B8.7065%2C49.4264%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22CBv%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.73065%2C49.435%5D%2C%5B8.704%2C49.41221%5D%2C%5B8.704590%2C49.4040%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22k%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.730%2C49.4021%5D%2C%5B8.71670%2C49.412%5D%2C%5B8.71467%2C49.430%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "filter=evomaster_1029427_input&" + 
                    "format=evomaster_1028887_inpu&" + 
                    "keys=highway&" + 
                    "showMetadata=true&" + 
                    "time=foo&" + 
                    "timeout=100&" + 
                    "types=foo&" + 
                    "values=evomaster_11614_input")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_233_createGeometryFromGeoJson
                .assertThat()
                .contentType("application/json")
    ...
    public void test_189_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/key?" + 
                    "bpolys=TLHeu%3A8.704561%2C49.403252%2C8.735%2C49.4088%2C8.7194%2C49.438%2C8.707%2C49.4381%2C8.704561%2C49.403.52%7CDaZ%3A8.704561%2C49.403252%2C8.735%2C49.429504%2C8.702%2C49.431%2C8.70724%2C49.418061%2C8.704561%2C49.403252&" + 
                    "filter=evomaster_1232854_input&" + 
                    "groupByKeys=pAVhbF&" + 
                    "keys=eoo&" + 
                    "time=0%2FP2M24D&" + 
                    "types=evomaster_1232855_input&" + 
                    "values=foo")
                .then()
    ...
    public void test_190_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/key?" + 
                    "bpolys=TLHeu%3A8.704561%2C49.403252%2C8.735%2C49.4088%2C8.7194%2C49.438%2C8.707%2C49.4381%2C8.704561%2C49.403.52%7CDaZ%3A8.704561%2C49.403252%2C8.735%2C49.429504%2C8.702%2C49.431%2C8.70724%2C49.418061%2C8.704561%2C49.40325&" + 
                    "filter=UkarzKClzKctNqX&" + 
                    "format=evomaster_1225099_input&" + 
                    "groupByKeys=pAVhbF&" + 
                    "keys=evomaster_1233199_input&" + 
                    "time=0%2FP2M24D")
                .then()
    ...
    public void test_191_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/key?" + 
                    "bpolys=TLHeu%3A8.7045%3A1%2C49.403252%2C8.735%2C49.4088%2C8.7194%2C49.438%2C8.707%2C49.4381%2C8.704561%2C49.403.52%7CDaZ%3A8.704561%2C49.403252%2C8.735%2C49.429504%2C8.702%2C49.431%2C8.70724%2C49.418061%2C8.704561%2C49.403252&" + 
                    "filter=evomaster_1232854_input&" + 
                    "format=evomaster_1225099_input&" + 
                    "groupByKeys=pAVdbF&" + 
                    "keys=evomaster_1233199_input&" + 
    ...
    public void test_193_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length/ratio/groupBy/boundary?" + 
                    "bboxes=8.67390%2C49.4177%2C8.7237%2C49.3947.&" + 
                    "filter=evomaster_1413676_input&" + 
                    "format=foo&" + 
                    "keys2=highway&" + 
                    "types=foo&" + 
                    "values2=residentia")
    ...
    public void test_194_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/ratio?" + 
                    "bboxes=Smy%3A8.6745.%2C49.4016%2C8.745%2C49.392%7CRW%3A8.672%2C49.426%2C8.720%2C49.383%7CKZg%3A8.689%2C49.400%2C8.719076%2C49.391&" + 
                    "keys=foo&" + 
                    "keys2=pighoax&" + 
                    "showMetadata=yes&" + 
                    "time=2013-08-31&" + 
    ...
    public void test_195_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/perimeter/ratio?" + 
                    "bboxes=I%3A8.6861%2C49.400872%2C8.731%2C49.3844%7CI%3A8.6563%2C49.4.274%2C8.7169%2C49.395%7Cf%3A8.694%2C49.4009%2C8.71170%2C49.38836%7CtycF%3A8.681%2C49.424%2C8.717%2C49.3944&" + 
                    "filter2=addr%3Ahousenumber%3D*+and+id%3A%281+..%1E9999%29&" + 
                    "format=csx&" + 
                    "keys=foo&" + 
                    "keys2=highway&" + 
                    "showMetadata=yes&" + 
                    "time=evomaster_1608892_input&" + 
                    "types2=foo&" + 
                    "values=foo")
                .then()
    ...
    public void test_197_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length/ratio/groupBy/boundary?" + 
                    "bboxes=8.67390%2C49.4177%2C8.7.37%2C49.3947&" + 
                    "showMetadata=false&" + 
                    "timeout=66&" + 
                    "types2=point%2Chife%2Cpolygon%2Cother&" + 
                    "values2=residentialk")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_65_createBboxes
                .assertThat()
                .contentType("application/json")
    ...
    public void test_198_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/ratio?" + 
                    "bboxes=x%3A8..65%2C49.4010%2C8.7367%2C49.394&" + 
                    "filter2=foo&" + 
                    "format=json&" + 
                    "keys=foo&" + 
                    "keys2=evomaster_926963_input&" + 
    ...
    public void test_199_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/ratio?" + 
                    "bboxes=x%3A8.665%2C49.4.10%2C8.7367%2C49.394&" + 
                    "filter=foo&" + 
                    "format=json&" + 
                    "keys=foo&" + 
                    "keys2=evomaster_926963_input&" + 
    ...
    public void test_200_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length/density/groupBy/type?" + 
                    ...
                    "filter=&" + 
                    "format=tqMTytO&" + 
                    "keys=evomctter_570_input&" + 
                    "time=evomaster_1966675_input&" + 
                    "timeout=0.6464262923286513&" + 
                    "types=evomaster_5758_input")
                .then()
    ...
    public void test_201_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/groupBy/boundary/groupBy/tag?" + 
                    "bpolys=Y%3A8.7.4561%2C49.403252%2C8.72388%2C49.42055%2C8.709%2C49.4335%2C8.703%2C49.408%2C8.704561%2C49.403252&" + 
                    "groupByKey=highway&" + 
                    "keys=highway&" + 
                    "time=2009-02-08&" + 
                    "timeout=57")
    ...
    public void test_202_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/length/density/groupBy/boundary?" + 
                    "bcircles=8.7.73%2C49.4276%2C6%7C8.712%2C49.438%2C5&" + 
                    "filter=foo&" + 
                    "format=csv&" + 
                    "keys=highway&" + 
                    "showMetadata=foo&" + 
    ...
    public void test_204_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/ratio?" + 
                    "bcircles=T%3A8.701439%2C49.4.94%2C4&" + 
                    "filter2=foow%21%3D*+Und+type%3ArelYUion+and0area%3AU1.0+..+2U60&" + 
                    "format=csv&" + 
                    "keys=hiehway&" + 
                    "keys2=evomaster_2157385_input&" + 
                    "types2=othER&" + 
                    "values=evomaster_2171374_input&" + 
                    "values2=bgY")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_114_createCircularPolygons
                .assertThat()
    ...
    public void test_205_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/density/groupBy/tag?" + 
                    "bboxes=UM%3A8.682.%2C49.416%2C8.733042%2C49.382%7CMe%3A8.681%2C49.415%2C8.735244%2C49.386%7CokE%3A8.6717%2C49.420%2C8.709%2C49.39807%7Cy%3A8.656089%2C49.421%2C8.7041%2C49.397063&" + 
                    "filter=evomaster_854550_input&" + 
                    "format=geojson&" + 
                    "groupByKey=EA6PyYhEjHRQdfl7&" + 
                    "showMetadata=true&" + 
                    "time=%2F&" + 
                    "timeout=7&" + 
                    "values=%60%3Ah3K9hYM%5C")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_63_createBboxes
                .assertThat()
                .contentType("application/json")
    ...
    public void test_206_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/density/groupBy/tag?" + 
                    "bboxes=UM%3A8.6822%2C49.416%2C8.733042%2C49.382%7CMe%3A8.681%2C49.415%2C8.735244%2C49.386%7CokE%3A8.6717%2C49.420%2C8.709%2C49.398.7%7Cy%3A8.656089%2C49.421%2C8.7041%2C49.397063&" + 
                    "filter=evomaster_854550_input&" + 
                    "format=geojsnn&" +
                    "groupByKey=EA6PyYhEjHRQdfl7&" + 
                    "groupByValues=evomastera854551_input&" + 
                    "showMetadata=true&" + 
                    "time=%2F&" + 
                    "timeout=1&" + 
                    "values=%60%3Ah3K9hYM%5B")
                .then()
    ...
    public void test_207_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/density/groupBy/tag?" + 
                    "bboxes=UM%3A8.6822%2C49.416%2C8.733042%2C49.382%7CMe%3A8.681%2C49.415%2C8.735244%2C49.386%7CokE%3A8.6717%2C49.420%2C8.709%2C49.39807%7Cy%3A8.656089%2C49.4.1%2C8.7041%2C49.397063&" + 
                    "filter=&" + 
                    "groupByKey=E%3D6PUYhEjHRQdfl7&" + 
                    "time=%2F&" + 
                    "values=%60%3Ah3K9hYM%5B")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/GeometryBuilder_73_createBboxes
    ...
    public void test_208_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/ratio/groupBy/boundary?" + 
                    "bboxes=I%3A8.654%2C49.424%2C8.757867%2C49.3830%7Cjdecr%3A8.67453%2C49.411155%2C8.70.650%2C49.399&" + 
                    "filter2=name%21%3D*+or+type%3Away+and+id%3A%281+..+9999%29&" + 
                    "keys2=digiway&" + 
                    "time=nodg%2Crehbtio&" + 
                    "types2=nodf%2CrelaTUonT8E&" + 
                    "values=foo&" + 
                    "values2=network%3D*+and+not+id%3A%281+..+99990")
                .then()
    ...
    public void test_209_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/density/groupBy/boundary/groupBy/tag?" + 
                    "bpolys=3574%2C8877&" + 
                    "groupByKey=YfOUeTSUNUb6&" + 
                    "keys=recycling%3Abatteries&" + 
                    "time=3574%2C8877&" + 
                    "types=fom")
                .then()
    ...
    public void test_210_with500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/key?" + 
                    "bpolys=XJHeu%3A8.504561%2C49.403252%2C82735%2C49.4%2C68%2C8.7195%2C49.438%2C8.707%2C4904381%2C8.703561%2C49.403.92%7CDaZ%3A8-744561%2C49.403212%2C8.735%2C49.4255040827%2F2%2C49.431%2B8.70724%2C49.418061%2C%3C&" + 
                    "format=CSv&" + 
                    "groupByKeys=VV1U%5EeR%5CHUo&" + 
                    "keys=cf&" + 
                    "showMetadata=cW0s%60p&" + 
                    "types=VZ2J_cRVMclu&" + 
                    "values=E")
                .then()
    ...
    public void test_211_with500() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/ratio?" + 
                    "bcircles=U%3A7.667%3AS%2C3226410%2C6&" + 
                    "keys2=toilets&" + 
                    "showMetadata=&" + 
                    "time=&" + 
                    "timeout=0&" + 
                    "types2=U%3A7.667%3AS%2C54.3051%2C")
                .then()
                .statusCode(500) // org/heigit/ohsome/ohsomeapi/inputprocessing/InputProcessor_224_processParameters
                .assertThat()
                .contentType("application/json")
                .body("'status'", numberMatches(500.0))
                .body("'error'", containsString("Internal Server Error"))
                .body("'message'", containsString("found non-noded intersection between LINESTRING ( -168.75001739994235 89.99994595727897, -157.50007127775913 89.9999459572872 ) and LINESTRING ( 168.75009026376608 89.99994595729262, -179.99996285435518 89.9999459572808 ) [ (-165.57490319446546, 89.99994595728128, NaN) ]"))
                .body("'path'", containsString("/elements/area/ratio"));
    }
    ...
    public void test_234() throws Exception {
        ...
        try{
            given().accept("*/*")
                    .post(baseUrlOfSut + "/users/count/density?" + 
                        "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22N%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.747%2C49.411995%5D%2C%5B8.702%2C49.43495%5D%2C%5B8.7028%2C49.413%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                        "showMetadata=yes&" + 
                        "timeout=63")
                    .then();
        } catch(Exception e){
    ...
    public void test_240() throws Exception {
        ...
        try{
            given().accept("*/*")
                    .post(baseUrlOfSut + "/users/count/groupBy/key?" + 
                        "bboxes=8.6682%2C49.426%2C8.701122%2C49.386%7C8.691%2C49.422074%2C8.748849%2C49.397&" + 
                        "filter=foot%21%3D*+or+not+type%3Anode+or+id%3A%281+..+9999%29&" + 
                        "groupByKeys=building%2Ctype&" + 
                        "showMetadata=yes&" + 
                        "timeout=83")
                    .then();
        } catch(Exception e){
    ...
    public void test_241() throws Exception {
        ...
        try{
            given().accept("*/*")
                    .post(baseUrlOfSut + "/users/count/density/groupBy/type?" + 
                        "bboxes=V%3A8.677%2C49.407%2C8.744%2C49.385%7CSfdvw%3A8.681774%2C49.412446%2C8.742%2C49.380%7CRN%3A8.660%2C49.4266%2C8.722%2C49.381%7CsL%3A8.6658%2C49.4216%2C8.7039%2C49.38705&" + 
                        "format=csv&" + 
                        "showMetadata=false&" + 
                        "timeout=28")
                    .then();
    ...
    public void test_258() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(1088.0))
    ...
    public void test_266() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(549.0))
    ...
    public void test_278() throws Exception {
        ...
        given().accept("text/csv")
                .get(baseUrlOfSut + "/elements/count/ratio?" + 
                    "bboxes=HXYly%3A8.682%2C49.4087%2C8.717%2C49.3817%7CYeL%3A8.6644%2C49.4179%2C8.71163%2C49.3854%7Cg%3A8.681%2C49.424%2C8.7435%2C49.391%7CbjXb%3A8.680%2C49.413%2C8.754%2C49.394&" + 
                    "filter2=addr%3Astreet%21%3D*+and+id%3A%281+..+9999%29&" + 
                    "format=csv&" + 
                    "keys2=highway&" + 
                    "showMetadata=false&" + 
                    "time=2011-09-03&" + 
    ...
    public void test_279() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(216.0))
    ...
    public void test_280() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(345.0))
                .body("'metadata'.'description'", containsString("Total count of items in absolute values, aggregated on the type."));
    }
    ...
    public void test_308() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(274.0))
    ...
    public void test_309() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(194.0))
    ...
    public void test_310() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(365.0))
                .body("'metadata'.'description'", containsString("Density of selected items (area of items in square meters divided by the area in square kilometers), aggregated on the tag."));
    }
    ...
    public void test_317() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/groupBy/tag?" + 
                    "bboxes=bw%3A8.687%2C49.423%2C8.7495%2C49.397&" + 
                    "filter=building%21%3D*+and+not+area%3A%281.0+..+1E6%29&" + 
                    "format=json&" + 
                    "groupByKey=building&" + 
                    "groupByValues=track%2Cfootway&" + 
                    "time=%2F%2FP1M1D")
                .then()
                .statusCode(200)
                .assertThat()
    ...
    public void test_318() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(329.0))
    ...
    public void test_322() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(1418.0))
                .body("'metadata'.'description'", containsString("Total length of items in meters satisfying types2, keys2, values2 parameters (= value2 output), as well as items selected by types, keys, values parameters (= value output) and ratio of value2:value, aggregated on the boundary objects."));
    }
    ...
    public void test_325() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(1154.0))
    ...
    public void test_330() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(1427.0))
                .body("'metadata'.'description'", containsString("Density of selected items (length of items in meters divided by the area in square kilometers)."));
    }
    ...
    public void test_331() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(994.0))
    ...
    public void test_338() throws Exception {
        ...
        given().accept("text/csv")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=00214.31%2C81.979%2C7&" + 
                    "filter=&" + 
                    "format=Csv&" + 
                    "keys=Gravuren%2C_Frontplatten%2C_Schilder%2C_Folienschnitte%2C_Pokale%2C_Medaillen&" + 
                    "showMetadata=&" + 
                    "timeout=31&" + 
                    "types=poINt&" + 
                    "values=evomaster_102984_input")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("text/csv");
    ...
    public void test_341() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(250.0))
    ...
    public void test_357() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=00214.31%2C79.978%2C7&" + 
                    "keys=evomaster_131236_knput&" + 
                    "types=POint&" + 
                    "values=evomaster_102984_input")
                .then()
                .statusCode(200)
    ...
    public void test_364() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(202.0))
    ...
    public void test_371() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(406.0))
    ...
    public void test_373() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(352.0))
    ...
    public void test_375() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(1163.0))
                .body("'metadata'.'description'", containsString("Total area of items in square meters."));
    }
    ...
    public void test_380() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(581.0))
                .body("'metadata'.'description'", containsString("Total area of items in square meters satisfying types2, keys2, values2 parameters (= value2 output), as well as items selected by types, keys, values parameters (= value output) and ratio of value2:value, aggregated on the boundary objects."));
    }
    ...
    public void test_390() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(229.0))
                .body("'metadata'.'description'", containsString("Total length of items in meters satisfying types2, keys2, values2 parameters (= value2 output), as well as items selected by types, keys, values parameters (= value output) and ratio of value2:value."));
    }
    ...
    public void test_393() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(228.0))
                .body("'metadata'.'description'", containsString("Density of selected items (length of items in meters divided by the area in square kilometers)."));
    }
    ...
    public void test_394() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(516.0))
    ...
    public void test_396() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(289.0))
    ...
    public void test_397() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(3649.0))
    ...
    public void test_398() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(1493.0))
    ...
    public void test_407() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(181.0))
    ...
    public void test_433() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(483.0))
                .body("'metadata'.'description'", containsString("Total perimeter of items in meters."));
    }
    ...
    public void test_434() throws Exception {
        ...
        given().accept("application/json")
                ...
                .body("'attribution'.'text'", containsString("�� OpenStreetMap contributors"))
                .body("'apiVersion'", containsString("1.3.0-SNAPSHOT"))
                .body("'metadata'.'executionTime'", numberMatches(73.0))
    ...
    public void test_439() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/groupBy/tag?" + 
                    "bcircles=VorVr%3A8.705967%2C49.400%2C3%7CsB%3A8.7043%2C49.4052%2C9&" + 
                    "filter=foo&" + 
                    "format=foo&" + 
                    "groupByKey=evomaster_143_input&" + 
                    "keys=highway&" + 
                    "showMetadata=evomaster_144_input&" + 
                    "time=%2F%2FP3M6D&" + 
                    "types=foo")
                .then()
                .statusCode(400)
    ...
    public void test_440() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/groupBy/key?" + 
                    "bcircles=8.733698%2C49.417%2C88%7C8.7480%2C49.4172%2C9&" + 
                    "format=foo&" + 
                    "groupByKeys=foo&" + 
                    "keys=evomaster_678_input&" + 
                    "time=%2F%2FP14D&" + 
                    "timeout=86&" + 
                    "types=foo&" + 
                    "values=track")
    ...
    public void test_444() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/density/groupBy/boundary?" + 
                    "bcircles=SjqM%3A8.724%2C49.40993%2C2%7CBo%3A8.732%2C49.41547%2C3%7CG%3A8.707216%2C49.4204%2C4&" + 
                    "keys=highway&" + 
                    "showMetadata=no&" + 
                    "types=foo&" + 
                    "values=evomaster_13635_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_449() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/perimeter/ratio?" + 
                    "bcircles=rtQN%3A8.727%2C49.435%2C4&" + 
                    "filter=barrier%21%3D*+or+geometry%3Aline+and+id%3A%281+..+9999%29&" + 
                    "format=csv&" + 
                    "timeout=42")
                .then()
                .statusCode(400)
    ...
    public void test_457() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/perimeter/groupBy/boundary?" + 
                    "bcircles=t%3A8.733923%2C49.423791%2C5%7CT%3A8.7261%2C49.436%2C7&" + 
                    "filter=foo&" + 
                    "format=foo&" + 
                    "timeout=60&" + 
                    "types=foo")
    ...
    public void test_460() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/perimeter/density/groupBy/type?" + 
                    "bpolys=x&" + 
                    "keys=4_w1W&" + 
                    "showMetadata=reLYzwo8LuN&" + 
                    "time=Tsu&" + 
                    "types=QuMaDPQNf1yfP&" + 
                    "values=GsTDounItqAmeS6")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_464() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/perimeter/density/groupBy/boundary/groupBy/tag?" + 
                    "bpolys=KT%3A8.704561%2C49.403252%2C8.733589%2C49.4160%2C8.704562%2C49.4320%2C8.70988%2C49.428%2C8.704561%2C49.403252&" + 
                    "format=json&" + 
                    "groupByKey=highwai&" + 
                    "groupByValues=foo&" + 
                    "showMetadata=false&" + 
                    "time=evomaster_2734_input&" + 
                    "types=foo&" + 
                    "values=tertiary")
                .then()
                .statusCode(400)
    ...
    public void test_468() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/perimeter/density?" + 
                    "bpolys=9&" + 
                    "format=GGZW&" + 
                    "showMetadata=j7rsMMVb802a&" + 
                    "time=PK5qA70b5xkj8s&" + 
                    "types=evomaster_78449_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_469() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/perimeter?" + 
                    "bpolys=O&" + 
                    "filter=8l&" + 
                    "format=Q2KUmTv_PhzoJb1Z&" + 
                    "keys=4JTO69egFTg&" + 
                    "showMetadata=evomaster_1388147_input&" + 
                    "timeout=0.49565563238356913&" + 
                    "types=TaTgk&" + 
                    "values=A")
                .then()
                .statusCode(400)
    ...
    public void test_470() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/perimeter?" + 
                    "bboxes=8.6632%2C49.403%2C8.758069%2C49.384%7C8.681%2C49.42803%2C8.702817%2C49.3952%7C8.6505%2C49.408785%2C8.747%2C49.386%7C8.68152%2C49.428%2C8.71576%2C49.3932&" + 
                    "bcircles=foo&" + 
                    "bpolys=foo&" + 
                    "filter=foo&" + 
                    "format=foo&" + 
    ...
    public void test_477() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/length/groupBy/key?" + 
                    "bcircles=jf%3A8.74951%2C49.43728%2C9%7CJOfQ%3A8.743%2C49.4358%2C9&" + 
                    "filter=evomaster_776812_input&" + 
                    "groupByKeys=evomaster_776813_inpu&" + 
                    "keys=foo&" + 
                    "showMetadata=no&" + 
                    "time=2009-09-03&" + 
                    "values=fqoW")
    ...
    public void test_478() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length/groupBy/key?" + 
                    "bpolys=N&" + 
                    "filter=zonUqQ6YdUK&" + 
                    "format=b6p0Gy6RMwJwqU&" + 
                    "groupByKeys=VLsKh9&" + 
                    "keys=Y9nJ3M1TIKX57Ct&" + 
                    "showMetadata=PENp0UtD1RKQh8Y&" + 
                    "values=yzMk7")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_481() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/length/groupBy/boundary?" + 
                    "bcircles=g%3A8.7304%2C49.43896%2C1&" + 
                    "filter=foo&" + 
                    "format=foo&" + 
                    "keys=highwa&" + 
                    "time=evomaster_22867_input&" + 
                    "timeout=25&" + 
                    "types=foo&" + 
                    "values=evomaster_22868_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_482() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length/groupBy/boundary?" + 
                    "bpolys=e&" + 
                    "filter=d8cdtrdnLmfEDe2S&" + 
                    "format=XBpQX9Z&" + 
                    "keys=LI8yzmVxzzIcc4e&" + 
                    "showMetadata=&" + 
                    "time=WYu4nMu&" + 
                    "timeout=")
                .then()
    ...
    public void test_483() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/length/density/groupBy/type?" + 
                    ...
                    "filter=%7CYViehEWiJ&" + 
                    "keys=%3Fx_%7DQUCElmC&" + 
                    "showMetadata=W5kfmhOlj&" + 
                    "time=SoQjFE%5EfJ%3Bn%3Apd&" + 
                    "values=%7CZWikf%3EUiA")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_484() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length/density/groupBy/type?" + 
                    "bcircles=&" + 
                    "bpolys=Y&" + 
                    "filter=evomaster_8062_input&" + 
                    "format=tqMTytO&" + 
                    "showMetadata=G4c5q9Dn&" + 
                    "types=clw2QyjOIV&" + 
                    "values=")
                .then()
                .statusCode(400)
    ...
    public void test_487() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length/density/groupBy/boundary/groupBy/tag?" + 
                    "bpolys=9&" + 
                    "groupByKey=JDC30oCyzwN1q&" + 
                    "groupByValues=Tdu0UyytMN9SIrn&" + 
                    "keys=UbYR83&" + 
                    "showMetadata=V3mqyjzoh&" + 
                    "time=0bZSXtz1&" + 
                    "types=syudNXCb")
                .then()
                .statusCode(400)
    ...
    public void test_490() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/length/density?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22hY%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.735%2C49.4031%5D%2C%5B8.726%2C49.4119%5D%2C%5B8.725893%2C49.425%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22uk%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.71330%2C49.4056%5D%2C%5B8.733%2C49.408%5D%2C%5B8.700824%2C49.426203%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22bRM%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.733%2C49.401%5D%2C%5B8.7429%2C49.43735%5D%2C%5B8.702073%2C49.415%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "format=foo&" + 
                    "keys=highway&" + 
                    "values=primary_link")
                .then()
    ...
    public void test_493() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length?" + 
                    ...
                    "filter=foo&" + 
                    "format=foo&" + 
                    "keys=evomaster_1164_input&" + 
                    "showMetadata=foo&" + 
                    "time=evomaster_1165_input&" + 
                    "timeout=49&" + 
                    "types=foo&" + 
                    "values=stop")
                .then()
    ...
    public void test_497() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/groupBy/type?showMetadata=")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_499() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/groupBy/tag?" + 
                    "bcircles=8.7048%2C49.429%2C4&" + 
                    "filter=foo&" + 
                    "format=geojson&" + 
                    "groupByKey=evomaster_71975_input&" + 
                    "keys=evomaster_71976_input&" + 
                    "time=foo&" + 
                    "values=platform")
                .then()
                .statusCode(400)
    ...
    public void test_500() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/groupBy/key?" + 
                    "groupByKeys=ZY7o0lFuJSV9&" + 
                    "showMetadata=8f5gNTdt1Timpm&" + 
                    "time=ZOD4y4B60&" + 
                    "timeout=kFb2SY&" + 
                    "values=EiPKjiD")
                .then()
    ...
    public void test_501() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/groupBy/boundary/groupBy/tag?" + 
                    "bcircles=8.7378%2C49.427048%2C7&" + 
                    "filter=turn%3D*+or+id%3A%281+..+9991%29&" + 
                    "format=geojson&" + 
                    "groupByKey=highway&" + 
                    "groupByValues=evomaster_1692902_input&" + 
                    "showMetadata=yes&" + 
                    "timeout=28&" + 
                    "types=foo")
                .then()
    ...
    public void test_502() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/groupBy/boundary?" + 
                    ...
                    "format=csv&" + 
                    "keys=highway&" + 
                    "showMetadata=evomaster_38_input&" + 
                    "timeout=100&" + 
                    "values=cycleway")
                .then()
                .statusCode(400)
    ...
    public void test_505() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/density/groupBy/type?" + 
                    "bpolys=N&" + 
                    "filter=OEf6weKMzhj22yd&" + 
                    "keys=jBO6&" + 
                    "types=z4zjH2DFun_xx9d&" + 
                    "values=KSslQ4J")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_508() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/density/groupBy/boundary/groupBy/tag?" + 
                    "bcircles=fk%3A8.706%2C49.40149%2C7%7CPE%3A8.712544%2C49.40520%2C6&" + 
                    "filter=foo&" + 
                    "format=csv&" + 
                    "groupByKey=evomaster_93360_input&" + 
                    "keys=highway&" + 
    ...
    public void test_509() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/density/groupBy/boundary/groupBy/tag?" + 
                    ...
                    "filter=foo&" + 
                    "groupByKey=evomaster_86875_input&" + 
                    "groupByValues=foo&" + 
                    "showMetadata=foo&" + 
                    "values=foo")
                .then()
    ...
    public void test_514() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count?" + 
                    "bcircles=KemPY%3A8.70672%2C49.41391%2C259%7CJtGaX%3A8.70745%2C49.4366%2C5&" + 
                    "filter=network%21%3D*+or+area%3A%281.0+..+1E6%29&" + 
                    "format=jsoo&" + 
                    "types=foo&" + 
                    "values=foo")
    ...
    public void test_520() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/groupBy/tag?" + 
                    "bpolys=HVg%3A8.704561%2C49.403252%2C8.70914%2C49.419%2C8.7160%2C49.430%2C8.728%2C49.4024%2C8.704561%2C49.403252&" + 
                    "format=geojson&" + 
                    "groupByKey=building&" + 
                    "groupByValues=primary%2Cyes&" + 
                    "time=2017-05-02&" + 
                    "timeout=94&" + 
                    "values=evomaster_1308423_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_525() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/groupBy/boundary?" + 
                    "bcircles=LkZK%3A8.710%2C49.400%2C4%7CEut%3A8.718951%2C49.413%2C7&" + 
                    "filter=foo&" + 
                    "keys=highway&" + 
                    "time=foo&" + 
                    "values=evomaster_4284_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_526() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density/groupBy/type?" + 
                    "bboxes=foo&" + 
                    "bcircles=cP%3A8.7411%2C49.417%2C35%7CE%3A8.7394%2C49.409%2C2%7CTzPI%3A8.700%2C49.42356%2C214932511&" + 
                    "filter=foo&" + 
                    "format=foo&" + 
                    "keys=highway&" + 
                    "time=2008-02-03&" + 
    ...
    public void test_528() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density/groupBy/tag?" + 
                    "bcircles=OvNL%3A8.734%2C49.43988%2C2&" + 
                    "groupByKey=evomaster_16865_input&" + 
                    "keys=highway&" + 
                    "showMetadata=evomaster_16866_input&" + 
                    "time=2012-12-22")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_534() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area?" + 
                    "bpolys=i&" + 
                    "filter=63tCyAg&" + 
                    "format=fio6YKrZjiBzDO5a&" + 
                    "showMetadata=fcKs1R_&" + 
                    "time=bAQWsFRHD7TA")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_537() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/perimeter/groupBy/type?" + 
                    ...
                    "filter=foo&" + 
                    "format=csv&" + 
                    "keys=evomaster_9243_input&" + 
                    "showMetadata=false&" + 
                    "time=evomaster_24510_input&" + 
                    "timeout=68&" + 
                    "types=pOLygon&" + 
                    "values=evomaster_24511_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_540() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/density/groupBy/boundary/groupBy/tag?" + 
                    "bcircles=8.749%2C72.1512%2C9&" + 
                    "filter=foo&" + 
                    "groupByKey=hmgjway&" + 
                    "groupByValues=scdqol%2Cfootway&" + 
                    "time=2014048-1%2FA")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_541() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=00214.33%2C84.000%2C%2F&" + 
                    "showMetadata=&" + 
                    "time=evomaster_489549_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_542() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area?" + 
                    "bcircles=%3A85%3A%5E%2C56.00000%2C0&" + 
                    "filter=ds4%2CFXAeIiqSIr&" + 
                    "showMetadata=foo&" + 
                    "time=ds4%2CFXAeIiqSIr&" + 
                    "timeout=&" + 
                    "values=cmaVUD%40")
                .then()
                .statusCode(400)
    ...
    public void test_543() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/ratio?" + 
                    "bcircles=UU8Q7UU%3A19%2C72%2C2142%2C&" + 
                    "format=csv&" + 
                    "keys=hdadsbP&" + 
                    "keys2=evomaster_2157385_input&" + 
                    "time=20J0-05-3%2F&" + 
    ...
    public void test_544() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=8.715031%2C-0.00D%2C7a&" + 
                    "filter=evomaster_606110_input&" + 
                    "format=e5ze3&" + 
                    "time=evomaster_45772_inpu&" + 
                    "timeout=31&" + 
                    "values=J5%607vbBrnY")
                .then()
                .statusCode(400)
    ...
    public void test_545() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/groupBy/key?" + 
                    "bpolys=sBbKS%3A8.704561%2C49.403252%2C8.724%2C%149.415486%2C8%2F704560%2C49.410907%2C8.7206%2C49.4285%2C4.704561%2C49.40325&" + 
                    "format=geojson&" + 
                    "groupByKeys=cmZkXwPd&" + 
                    "showMetadata=evomaster_75445_input&" + 
                    "values=foo")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_547() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22Yd%22%3A%22LZBRd%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygof%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.741%2C49.4319%5D%2C%5B8.7498%2C49.439242%5D%2C%5B8.7486%2C49.4197%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22X%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704563%2C49.403252%5D%2C%5B8.7102%2C49.413%5D%2C%5B8.704538%2C49.43390%5D%2C%5B8.704%2C49.403%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "format=evomaster_31928_input&" + 
                    "keys=evomaster_24502_input&" + 
                    "showMetadata=evomaster_799359_input&" + 
                    "time=evomaster_78727_input&" + 
                    "timeout=56&" + 
                    "types=rx5rdF34tR6%40")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_548() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/density/groupBy/boundary?" + 
                    "bpolys=UPR6BL2D7o3v3ATS&" + 
                    "format=evomaster_10461_input&" + 
                    "keys=7I&" + 
                    "showMetadata=evomaster_10462_input&" + 
                    "time=%2F&" + 
                    "timeout=Ww5O8R84DY6HAJ&" + 
                    "types=7dLvjO2uyBKa")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_551() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=8.715031%2C-9.828%2C7&" + 
                    "filter=evomaster_47262_input&" + 
                    "keys=cLDdiTZnhaOt&" + 
                    "showMetadata=&" + 
                    "time=evomaster_49582_input&" + 
                    "types=oTher&" + 
                    "values=J5%607vcBrn")
                .then()
                .statusCode(400)
    ...
    public void test_552() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/groupBy/key?" + 
                    "bpolys=sBbKS%3A8.744561%2C49.403252%2C8.724%2C49.415486%2C8%2F704560%2C49.410907%2C8.7206%2C49.4285%2C8.704561%2C49.403251&" + 
                    "groupByKeys=evomaster_8757_input&" + 
                    "showMetadata=true&" + 
                    "timeout=72&" + 
                    "types=MK1qaw&" + 
                    "values=foo")
    ...
    public void test_553() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=9.9989%3A3%2C59.438%2C%3F&" + 
                    "filter=&" + 
                    "format=evomaster_75986_input&" + 
                    "keys=WQn8dtUr3AGt&" + 
                    "showMetadata=&" + 
                    "time=evomaster_758430_input&" + 
                    "timeout=31")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_554() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=00%3A12.0%3A%2C63.999%2CG&" + 
                    "filter=&" + 
                    "keys=evomaster_873147_input&" + 
                    "showMetadata=&" + 
                    "time=DSepfuFEOH&" + 
                    "timeout=-429856.025243425&" + 
                    "types=POINT")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_555() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=3.315%3A%2B0%2C78.838%2C7ch&" + 
                    "format=CSV&" + 
                    "keys=evomaster_302658_input&" + 
                    "showMetadata=&" + 
                    "time=evokaster_103089cinpu")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_556() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=3.315%3A42%2C78.838%2C7&" + 
                    "format=CSV&" + 
                    "showMetadata=&" + 
                    "timeout=31&" + 
                    "types=evomaster_410461_input&" + 
                    "values=aBLvH")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_557() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22propebties%22%3A%7B%22id%22%3A%22LZBRd%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.741%2C49.4319%5D%2C%5B8.7498%2C49.439242%5D%2C%5B8.7486%2C49.4197%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22X%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704563%2C49.403252%5D%2C%5B8.7102%2C49.413%5D%2C%5B8.704538%2C49.43390%5D%2C%5B8.704%2C49.403%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "filter=evomaster_31927_input&" + 
                    "format=Csv&" + 
                    "keys=mvomaster_24502_input&" + 
                    "showMetadata=ezorasdfr_53442_inUuU&" + 
                    "time=evomaster_90942_input&" + 
                    "timeout=56&" + 
                    "types=evomaster_267399_input&" + 
                    "values=F5Qw8eX43jpqw")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_558() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=3.315%3A34%2C78.838%2C7&" + 
                    "keys=naKYiuj3U&" + 
                    "showMetadata=truE&" + 
                    "time=3.315%3A34%2C78.838%2C7c&" + 
                    "timeout=31&" + 
                    "types=waY&" + 
                    "values=aBLvpa")
                .then()
    ...
    public void test_560() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=8.715031%2C-9.828%2C7s&" + 
                    "format=jron&" + 
                    "keys=cLDdiTZnhaOt&" + 
                    "showMetadata=&" + 
                    "time=evomaster_45772_input&" + 
                    "timeout=31&" + 
                    "types=evomaster_38304_input&" + 
                    "values=J5P7vcBrn")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_561() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=3.715031%2C59.838%2C7&" + 
                    "filter=addr%3Ahousenumber%21%3D*+and+type%3Anode%1Fand+not+area%3A%281.0+..+1E6%29&" + 
                    "keys=cLD%C2%84iTZnlaOt&" + 
                    "showMetadata=no&" + 
                    "time=&" + 
                    "types=rELatioN&" + 
                    "values=J5P7vcBsn")
    ...
    public void test_564() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=0.719245%2C59.428%2C7&" + 
                    "filter=evomaster_221201_input&" + 
                    "time=evomaster_19763_input&" + 
                    "timeout=%2B1&" + 
                    "types=&" + 
                    "values=XBAg2%5DJFelnDQG3")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_567() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/density?" + 
                    "bcircles=MK%3A8.733595%2C49.406%2C&" + 
                    "filter=foo&" + 
                    "format=foo&" + 
                    "time=evomaster_4068_input&" + 
                    "types=foo&" + 
                    "values=evomaster_4075_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_568() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/groupBy/boundary/groupBy/tag?" + 
                    "bboxes=foo&" + 
                    "bcircles=evomaster_7017_input&" + 
                    "bpolys=foo&" + 
                    "filter=foo&" + 
                    "format=csv&" + 
                    "groupByKey=tower%2Ccivic&" + 
                    "groupByValues=tower%2Ccivic&" + 
                    "showMetadata=%C2%86oo&" + 
                    "types=evomaster_6643_input&" + 
                    "values=evomaster_6644_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_569() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=0.719231%2C59.428%2C7&" + 
                    "filter=addr%3Ahousenumber%21%3D*+and+type%3Anode+and+not+area%3A%281.0+..+1E6%29&" + 
                    "showMetadata=evomaster_16969_input&" + 
                    "time=evomaster_16911_input&" + 
                    "timeout=31&" + 
                    "types=fooi&" + 
                    "values=evomaster_17145_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_570() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=86719231%2C59.028%2C7&" + 
                    "filter=addOdtomsInCmb%40L%60%3D*KaNDUpyUUU%5Ekde+Uld+UotUUreaU%28U.0+..U1UU0&" + 
                    "showMetadata=no&" + 
                    "time=evomaster_17239_input&" + 
                    "types=evomaster_30723_input&" + 
                    "values=evomaster_30724_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_571() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/ratio/groupBy/boundary?" + 
                    "bboxes=F%3A8.671%2849.415%2C8.728%2C49.39730%7CQ%3A8.660%2C49.4015%2C8.75306%2C49.390&" + 
                    "filter=evomaster_25277_input&" + 
                    "format=foo&" + 
                    "keys2=foo&" + 
                    "showMetadata=yes&" + 
                    "time=foo&" + 
                    "types=foo&" + 
                    "types2=evomaster_25278_input&" + 
                    "values=evomaster_25279_input&" + 
                    "values2=foo")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_572() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=8.711231%2C59.42%3A%2C7&" + 
                    "filter=evomaster_17636_input&" + 
                    "keys=evomaster_28035_input&" + 
                    "showMetadata=falSE&" + 
                    "time=evomaster_28036_input&" + 
                    "types=rElATIon&" + 
                    "values=evomaster_16912_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_573() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=9.000000%2C79.438%2C7&" + 
                    "filter=evomastera10N350_inpuh&" + 
                    "format=GeOJson&" + 
                    "keys=evomaster_429640_input&" + 
                    "showMetadata=&" + 
                    "time=evom%5Dster_1%40826%2Faivpu&" + 
                    "timeout=31&" + 
                    "types=relATIoN&" + 
                    "values=KTVN")
                .then()
    ...
    public void test_574() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=3.315%3A21%2C78.838%2C7ch&" + 
                    "filter=evomaster_396577_input&" + 
                    "format=CSV&" + 
                    "keys=evomaster_396578_input&" + 
                    "showMetadata=&" + 
                    "timeout=21")
                .then()
                .statusCode(400)
    ...
    public void test_575() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=3.315%3A33%2C78.838%2C7c&" + 
                    "filter=evomaster_405551_input&" + 
                    "keys=naKYiuj3U&" + 
                    "showMetadata=")
                .then()
                .statusCode(400)
    ...
    public void test_576() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density?" + 
                    "bpolys=PMqypeLP%22F%3D%3CBBrefNlttstUonU%2CUfUUduUeU%22U%5B%7B%22tUUeUU%22FUaturd%22UUUroUeUtiUU%22%3A%7B0idUU%22LZBRUBU%2C0gUUmeUUU%22%3A%7BUUype%22%3A%22PolyUUU%22U%22C_UrUiUateU%22%3A%5BKUU.7045%3EUU49UU0UUU2U%2CUU.9U1U49U4%3B19%5DU%5BHUU49UU49.43UR42%5D%2C%5B4U748U%2C49U41UU%5DU%5B8UU0U5U1%2C4U.803UUU%5D%5Dm%7DU%2C%7BBUyqeU%3A%22FUUUurU%22%2CUpropUrUUdU%22U%7B%22idUU%22U0%7D%2C%22UdoUUtUUUUw%22tyUUU%3A%22PoUygUUU%2CUcoordUnaUUUU%3AUU%5B7UU0U56U%2CU%3B.44325U%5D%2C%5B8.710BU49.413%5DUU8.7U45C8UU9.43390%5D0U8UUU2U4Y.U13%5DU%5B867UUU60%2C4U.403U5U%5D%5D%5D%7DU%5DU&" + 
                    "format=Csv&" + 
                    "keys=evomaster_24502_input&" + 
                    "showMetadata=erU%5DasteUj5UX41gUUUut&" + 
                    "time=foo&" + 
                    "types=evomaster_53243_input&" + 
                    "values=F5Qw8eX43jpqw")
                .then()
    ...
    public void test_577() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/density/groupBy/tag?" + 
                    "bboxes=evomaster_274409_input&" + 
                    "bcircles=foo&" + 
                    "bpolys=foo&" + 
                    "filter=fgo&" + 
                    "format=giojson&" + 
                    "groupByKey=evomaster_27%2C408_input&" + 
                    "groupByValues=evomaster%3F232427_input&" + 
                    "keys=yPmAdwdGFPSdNf&" + 
                    "showMetadata=true&" + 
                    "time=YkKzm_rND1Y&" + 
                    "timeout=evomaster_274410_input&" + 
                    "types=foo&" + 
                    "values=bus_stop")
                .then()
                .statusCode(400)
    ...
    public void test_578() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/density/groupBy/tag?" + 
                    "bpolys=Xx&" + 
                    "filter=ERO9IaAvlIiV&" + 
                    "format=I8H3o4iZP3HYJ&" + 
                    "groupByKey=evomaster_1%2C71181_input&" + 
                    "showMetadata=dcryoXMJ_fmSV&" + 
                    "timeout=Stw0glsg")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_579() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area?" + 
                    "bcircles=8.727%2C49.44886%2C8&" + 
                    "filter=foo&" + 
                    "time=2U%2F%2F-T810%3E&" + 
                    "timeout=96&" + 
                    "values=trafficcmirtor")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_580() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area?" + 
                    "bcircles=8.727%2C49.42866%2C8&" + 
                    "filter=foo&" + 
                    "time=2%2F%2F0-%2F9-06")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_582() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area?" + 
                    "bcircles=8.707%2C45.76272%2C6&" + 
                    "filter=trafficcmirt&" + 
                    "keys=N5oLFHC0NZHtNHx&" + 
                    "time=%2FU3%2F%2FT91U%3E")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_583() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=0.719231%2C99.428%2C7&" + 
                    "filter=8h2WO5JmVnBqCGS&" + 
                    "format=jron&" + 
                    "keys=foo&" + 
                    "showMetadata=&" + 
                    "time=evomaster_19336_input&" + 
                    "types=xvrPnS4d6&" + 
                    "values=XDAg%12UJFepnDQG3")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_584() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=8.715031%2C-96828%2C7s&" + 
                    "filter=addr%3Ahousenumber%21%3D*+and+type%3Anode%1Fand+not+area%3A%281.0+..+1E6%29&" + 
                    "format=jron&" + 
                    "showMetadata=&" + 
                    "time=evomaster_47218_input&" + 
                    "timeout=3&" + 
                    "types=M61sszZEV2LO_Qm&" + 
                    "values=J5P7vcBrn")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_585() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/ratio/groupBy/boundary?" + 
                    "bcircles=8.723%2C49.4382%2C4&" + 
                    "filter=addr%3Astreet%21%3D*+and+type%3Arelation+and+area%3A%281.0+..+1E6%29&" + 
                    "filter2=ref%21%3D*+or+length%3A%28+..+100%29&" + 
                    "format=foo&" + 
                    "keys=evomaster_22_input&" + 
                    "showMetadata=true&" + 
                    "time=2017-05-12&" + 
                    "types=foo&" + 
                    "types2=point%2Cother&" + 
    ...
    public void test_586() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length/ratio/groupBy/boundary?" + 
                    "bboxes=8.67390%2C49.4177%2C8.7237%2C49.39472&" + 
                    "filter=building%21%3D*+and+not+area%3A%281.0+..+1E6%29&" + 
                    "keys=fno&" + 
                    "time=foo&" + 
                    "types=8.67390%2C49.%2C177%2C8.7237%2C49.39472&" + 
                    "types2=point%2Cline%2Cpolygon%2Cothez&" + 
                    "values=foo&" + 
                    "values2=plumber")
                .then()
                .statusCode(400)
    ...
    public void test_589() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density?" + 
                    "bpolys=y%3EvwqN%22%3A%3DFeathreCoNleatUUnUU0UUaUUnUsU%3A%3BUUUUUe0%3A%22Ueatqre%22%2CUpUopertUUU%222%7BUiU%22%3A%22UUBRd%22%7DU%22gUoUetUu0U%7B%22UypU%22U%22PoUygoUUU%22aoorUUUatUsUU%5BU%5BXU7045U3%2C49.U0SU52M%2C%5BUU74U%2CUUN%3C3U9%5DUUU.749H0U9U4U9240%5D%2C%5B8U748F%2CUU.UUU7UU%5BH.7UU561%2CU9UU0UU5BU%5D%5D%7D%7D%2CU%22typeU%3A%22UealureU0%22prUUUUtUus%22J%7B%22Ud%22%3AUXUm%2C%22geoUeUUUUJU%22tyxUU%3AUUolyUUo0%2C%22UooUdiUateU%22%3A%5B%5C%5BU.7U456U%2CU9UU03U5UU%2CUUNW1%40U0UUUU1U%5D%2CU8.U0453ULU%3B2U3%3B90%5D%2C%5BU.U04%2C47.40UU%2C%5BU.7U072Q%2C49U40325U%5D%5D%5D%7D%7D%5D%7D&" + 
                    "filter=rmYXqvqFokODJ0pX&" + 
                    "format=csv&" + 
                    "keys=evomaster_44710_input&" + 
                    "time=foo&" + 
                    "timeout=57&" + 
                    "types=foo")
                .then()
    ...
    public void test_590() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length/ratio?" + 
                    ...
                    "filter2=foo&" + 
                    "showMetadata=evomaster_25_input&" + 
                    "time=foo&" + 
                    "timeout=55&" + 
                    "types2=node%2Cway%2Crelation")
                .then()
    ...
    public void test_591() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/density/groupBy/tag?" + 
                    "bboxes=UM%3A8.6822%2C49.416%2C8.733042%2C49.382%7CMe%3A8.681%2C49.415%2C8.735244%2C49.386%7CokEJ8.6717%2C49.420%2C8.709%2C49.39807%7Cy%3A8.656089%2C49.421%2C8.7041%2C49.397063&" + 
                    "filter=foo&" + 
                    "groupByKey=UmlmaUUeR_202M%5B_onpue&" + 
                    "groupByValues=goo&" + 
                    "showMetadata=true&" + 
                    "time=evomaster_294032_input&" + 
                    "timeout=50&" + 
                    "values=bus_stop")
                .then()
                .statusCode(400)
    ...
    public void test_592() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density?" + 
                    "bpolys=%7B%22type%22%3A%22Fe%C2%81tureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22LZBRd%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygof%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.741%2C49.4319%5D%2C%5B8.7498%2C49.439242%5D%2C%5B8.7486%2C49.4197%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22X%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704563%2C49.403252%5D%2C%5B8.7102%2C49.413%5D%2C%5B8.704538%2C49.43390%5D%2C%5B8.704%2C49.403%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "filter=evomaster_31927_input&" + 
                    "format=CSv&" + 
                    "keys=evomaster_24502_input&" + 
                    "showMetadata=evomaster_53232_input&" + 
                    "time=evomaster_295510_input&" + 
                    "timeout=56&" + 
                    "types=%60x5fdFN4tzDU7")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_593() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/key?" + 
                    "bboxes=PxGg&" + 
                    "bcircles=GGNpB5h_ni2s3&" + 
                    "bpolys=BaJKSPb3dapcL&" + 
                    "filter=lpUF8bDpflsbJ&" + 
                    "groupByKeys=%2C&" + 
                    "keys=leqBeFs&" + 
                    "time=WPU9EuigpHe9TYU&" + 
                    "values=0YC%40q4TA3180uVc")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_595() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/ratio/groupBy/boundary?" + 
                    "bcircles=ei%3A8.7194%2C49.425%2C6%7CEb%3A8.7476%2C49.419110%2C7%7CdlRVQ%3A8.720%2C49.403%2C9%7CK%3A8.730695%2C49.404%2C108&" + 
                    "filter=foo&" + 
                    "filter2=evomaster_141_input&" + 
                    "keys=evomaster_142_input&" + 
                    "keys2=highway&" + 
                    "showMetadata=yes&" + 
                    "time=foo&" + 
                    "timeout=44&" + 
    ...
    public void test_596() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/groupBy/key?" + 
                    "bcircles=V%3A8.746379%2C49.4074%2C5335784%2F4&" + 
                    "filter=oneway%3D*+or+geometry%3Apoint+and+not+area%3A%281.0+..+1E6%29&" + 
                    "groupByKeys=evomaster_557_input&" + 
                    "types=foo")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_597() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/type?" + 
                    "filter=lnjU_TueoSCfBq&" + 
                    "timeout=Ah1uwKVLe1wEjOa&" + 
                    "types=")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_598() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/length/density/groupBy/boundary/groupBy/tag?" + 
                    "bboxes=8.690%2C49.4B1771%2C8.7450%2C49.394&" + 
                    "filter=foo&" + 
                    "groupByKey=foo&" + 
                    "groupByValues=church%2Csteps%2Cstreet_lamp&" + 
                    "keys=foo&" + 
    ...
    public void test_599() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density/groupBy/tag?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22a%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.725%2C49.4085%5D%2C%5B8.7274%2C49.435%5D%2C%5B8.746%2C49.4382%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22fJ%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.706.49.408%5D%2C%5B8.739%2C49.428%5D%2C%5B8.74709%2C49.402%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "groupByKey=highway&" + 
                    "time=evomaster_7478_input&" + 
                    "timeout=95")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_600() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/key?" + 
                    "bpolys=TLHeu%3A8.704561%2C49.403252%2C8.735%2C49.4088%2C8.7194%2C49.438%2C8.707%2C49.4381%2C8.704561%2C49.40S252%7CDaZ%3A8.704561%2C49.403252%2C8.735%2C49.429504%2C8.702%2C49.431%2C8.70724%2C49.418061%2C8.704561%2C49.403252&" + 
                    "filter=evomaster_8451_input&" + 
                    "format=foo&" + 
                    "groupByKeys=evomaster_8452_input&" + 
                    "keys=evomaster_8453_input&" + 
                    "showMetadata=foo&" + 
                    "time=evomaster_8454_input&" + 
                    "values=evomaster_8455_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_603() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=00%3A14.31%2C79.978%2C7c&" + 
                    "format=cSv&" + 
                    "keys=evomaster_137904_input&" + 
                    "showMetadata=&" + 
                    "time=b7S&" + 
                    "types=PoinT&" + 
                    "values=evomaster_102984_input")
    ...
    public void test_604() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=3.315%3A31%2C78.838%2C7c&" + 
                    "filter=addr%3Ahousenumber%21%3D*+and+type%3Anode%1Fand+not+area%3A%281.0+..+1E6%29&" + 
                    "keys=evomaster_302658_input&" + 
                    "time=evokaster_103089cinpu&" + 
                    "types=s79Ql2MYsDvbj5&" + 
                    "values=evomaster_102984_input")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_605() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=3.315%3A34%2C78.838%2C7c&" + 
                    "filter=evomaster_302923_input&" + 
                    "keys=naKYiuj3U&" + 
                    "showMetadata=&" + 
                    "time=evokaster_103089cinpu&" + 
                    "timeout=31&" + 
    ...
    public void test_609() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22LZ%3BRd%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polyhmr%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.741%2C49.4319%5D%2C%5B8.7498%2C49.439242%5D%2C%5B8.7486%2C49.4197%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22X%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Pol%C2%81gon%22%2C%22coordinates%22%3A%5B%5B%5B8.704563%2C49.403252%5D%2C%5B8.7102%2C49.413%5D%2C%5B8.704538%2C49.43390%5D%2C%5B8.704%2C49.403%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "filter=NZx6jUfz2gMnS_hu&" + 
                    "format=CSV&" + 
                    "keys=avombs%7Cev_802372_hnput&" + 
                    "showMetadata=ehoejstgmiL90%3B3_MUp%C2%85U&" + 
                    "time=evomaster_810833_inpuu&" + 
                    "timeout=16&" + 
                    "types=evomaster_2125637_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_610() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=9.313031%2C79.338%2C7&" + 
                    "keys=evomaster_106%2F32_imput&" + 
                    "time=evom%5Dster_%2F%40826%2Fainput&" + 
                    "types=rELatioN&" + 
                    "values=h_UQmLeF8uIdx8wH")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_611() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area?" + 
                    "bcircles=8.707%2C45.74272%2C6&" + 
                    "filter=trafficcmirt&" + 
                    "keys=N5oLFHC0NZHtNHx&" + 
                    "time=%2FU3%2F%2BT91U%3E")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_612() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/ratio?" + 
                    "bboxes=s4qIZBBh8oWGS7&" + 
                    "bpolys=im2wXv0StnXN&" + 
                    "filter2=iBgYH71MhO1Poz&" + 
                    "format=iLZzGoecBwFs&" + 
                    "keys=l&" + 
                    "timeout=319&" + 
                    "types=AotWnbh_chOh&" + 
    ...
    public void test_613() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/density/groupBy/tag?" + 
                    "bboxes=UM%3A8.6822%2C49.416%2C8.733042%2C49.382%7CMe%3A8.681%2C49.415%2C8.735244%2C49.386%7CokE%3A8.6717%2C49.420%2C8.709%2C49.39807%7Cy%3A8.656089%2C49.421%2C8.7041%2C49.397063&" + 
                    "filter=foo&" + 
                    "groupByKey=evomaster_20229_input&" + 
                    "groupByValues=foo&" + 
                    "time=%2F%2FP3D")
    ...
    public void test_614() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/ratio?" + 
                    "bcircles=U%3A8.94284%2C-100661%2C8&" + 
                    "filter=&" + 
                    "keys=eoo&" + 
                    "keys2=I3Nm_HTU6P&" + 
                    "showMetadata=No&" + 
    ...
    public void test_615() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/density/groupBy/tag?" + 
                    "bcircles=v&" + 
                    "format=vBPfgqrrU9zl&" + 
                    "groupByKey=e3dh_E0cCvv&" + 
                    "keys=PRLAuDJnX&" + 
                    "showMetadata=d5BV&" + 
                    "time=j41d7jiEM&" + 
                    "types=kR&" + 
                    "values=XEzRffel0WrMi")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_617() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density?" + 
                    "bpolys=%7B%22type%22%3A%22FeatureCollection%22%2C%22features%22%3A%5B%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22LZBRd%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygof%22%2C%22coordinates%22%3A%5B%5B%5B8.704561%2C49.403252%5D%2C%5B8.741%2C49.4319%5D%2C%5B8.7498%2C49.439242%5D%2C%5B8.7486%2C49.4197%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%2C%7B%22type%22%3A%22Feature%22%2C%22properties%22%3A%7B%22id%22%3A%22X%22%7D%2C%22geometry%22%3A%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B8.704563%2C49.403252%5D%2C%5B8.7102%2C49.413%5D%2C%5B8.704538%2C49.43390%5D%2C%5B8.704%2C49.403%5D%2C%5B8.704561%2C49.403252%5D%5D%5D%7D%7D%5D%7D&" + 
                    "format=CSV&" + 
                    "keys=evomaster_24502_input&" + 
                    "showMetadata=evomaster_53232_input&" + 
                    "time=evomaster_78727_input&" + 
                    "timeout=56&" + 
                    "types=evomaster_294350_input&" + 
                    "values=F5Qw8eX43jpq")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_618() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/perimeter/ratio?" + 
                    ...
                    "time=a&" + 
                    "types=Jsc4M21oLan&" + 
                    "types2=W11NTFaC7boJR&" + 
                    "values=0RTD9cWteIf4q_&" + 
                    "values2=zwBIVu7MYpY_nHDj")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_619() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=%3A-002001%2C79.437%2C7M&" + 
                    "filter=evomas%C2%94er_10N350_inpuh&" + 
                    "format=GeOJson&" + 
                    "keys=evomaster_429640_input&" + 
                    "showMetadata=&" + 
                    "time=evomaster_433435_input&" + 
                    "types=rElAtiOn")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_620() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length/ratio?" + 
                    ...
                    "filter=&" + 
                    "filter2=AUE1NwFQpl&" + 
                    "keys=5pTocgVVBIF2Sew&" + 
                    "time=1&" + 
                    "types=XdaotVOsdeB3x&" + 
                    "values=o&" + 
                    "values2=eRw0T2_kuqrcQz3E")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/density/groupBy/boundary?" + 
                    "bboxes=r&" + 
                    "filter=pGHHxqR&" + 
                    "showMetadata=5O4W_D1DXTeDd&" + 
                    "time=&" + 
                    "types=UP1gn2CIJWL1Cz&" + 
                    "values=7Y93")
                .then()
                .statusCode(400)
                .assertThat()
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/groupBy/boundary/groupBy/tag?" + 
                    "bcircles=yDY8B_1yW1U4MH&" + 
                    "bpolys=iXaMVlScFxcYXmRZ&" + 
                    "filter=HIWLkyl7gTiSe83u&" + 
                    "format=B&" + 
                    "groupByKey=psr4jRjloj5&" + 
                    "keys=AntX21sU2vALl8M5&" + 
                    "showMetadata=TEfWFy&" + 
                    "timeout=FtzSsfa_p5")
                .then()
                .statusCode(400)
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/groupBy/boundary?" + 
                    "bpolys=ctGpvOhgz&" + 
                    "format=PyoYyvg1P1lnG6VR&" + 
                    "keys=vJ90&" + 
                    "showMetadata=tUo2YS9QmSVdMKms&" + 
                    "time=DMHzohfh4iX5a&" + 
                    "timeout=OYTUmKuYwdwa&" + 
                    "types=")
                .then()
                .statusCode(400)
                .assertThat()
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/density?" + 
                    "bboxes=&" + 
                    "bcircles=EsusWR&" + 
                    "bpolys=hxOUmuqPbXZkIxb6&" + 
                    "filter=&" + 
                    "format=XHLrA6nYKN&" + 
                    "showMetadata=svgeHpmVuO4mC")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_621() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=8.719221%2C59.428%2C7&" + 
                    "filter=8.719221%2C59.428%2C7&" + 
                    "keys=foo&" + 
                    "showMetadata=&" + 
                    "time=evomaster_19461_input&" + 
                    "timeout=31&" + 
                    "types=lINe&" + 
                    "values=evomaster_17069_input")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_622() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=8.719231%2C59.428%2C7&" + 
                    "filter=addr%3Ahousenumber%21%3D*+and+type%3Anode+and+not+area%3A%281.0+..+1E6%29&" + 
                    "format=jron&" + 
                    "showMetadata=false&" + 
                    "time=%2F%2FL2Y9M2D&" + 
    ...
    public void test_623() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=3.315031%2C79.838%2C7&" + 
                    "keys=ivomaster_103001_input&" + 
                    "showMetadata=True&" + 
                    "time=evomaster_103089_input&" + 
                    "timeout=31&" + 
                    "types=waY&" + 
                    "values=evomaster_102984_input")
                .then()
    ...
    public void test_624() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/density/groupBy/tag?" + 
                    ...
                    "filter=evomaster_854550_input&" + 
                    "format=geojson&" + 
                    "groupByKey=evomaster_851794_input&" + 
                    "groupByValues=evomaster_854551_input&" + 
                    "keys=f4K4i&" + 
                    "time=%2F&" + 
                    "timeout=5&" + 
                    "values=%60%3Ah3K9hYM%5E")
                .then()
                .statusCode(400)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_626() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=30315031%2C79.858%2C7&" + 
                    "filter=evomaster_108607_input&" + 
                    "keys=ivomaster_103081_input&" + 
                    "showMetadata=&" + 
                    "time=evomaster_103089_input&" + 
                    "timeout=31&" + 
                    "types=rELatioN&" + 
    ...
    public void test_627() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/groupBy/key?" + 
                    "bpolys=sBbKS%3A8.704561%2C49.403252%2C8.724%2C49.415486%2C8%2F704560%2C49.410907%2C8.7206%2C49.4285%2C8.704561%2C49.403251&" + 
                    "groupByKeys=evomaster_8757_input&" + 
                    "keys=foo&" + 
                    "showMetadata=true&" + 
                    "timeout=72&" + 
    ...
    public void test_628() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/key?" + 
                    "bpolys=TLHeu%3A8.704561%2C49.403252%2C8.735%2C49.4088%2C8.7194%2C49.438%2C8.707%2C49.4381%2C8.704561%2C49.403252%7CDaZ%3A8.704561%2C49.403252%2C8.735%2C49.429504%2C8.702%2C49.431%2C8.70724%2C49.418061%2C8.704561%2C49.40325&" + 
                    "filter=SziG&" + 
                    "groupByKeys=evomaster_535241_input&" + 
                    "keys=UUo&" + 
                    "showMetadata=evomaster_535246_input&" + 
                    "time=evomaster_535242_input&" + 
                    "values=foo")
                .then()
                .statusCode(400)
                .assertThat()
    ...
    public void test_630() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/groupBy/boundary?" + 
                    "bboxes=vcW%3A8.681%2C49.4002%2C7.727349%2C49.3841%7CEEULH%3A8.686607%2C49.415%2C8.749%2C49.387%7CZHEc%3A8.674893%2C49.406484%2C8.7064%2C49.391&" + 
                    "filter=evomaster_67362_input&" + 
                    "format=json&" + 
                    "keys=evomaster_24576_input&" + 
                    "time=fom&" + 
                    "timeout=62")
                .then()
                .statusCode(404)
    ...
    public void test_631() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/groupBy/type?" + 
                    "bcircles=8.700%2C41.403%2C4%7C8.70075%2C49.436%2C1%7C8.747%2C49.4015%2C6%7C8.717%2C49.427260%2C23&" + 
                    "format=geojson&" + 
                    "showMetadata=no&" + 
                    "timeout=24&" + 
                    "values=foo")
    ...
    public void test_632() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count?" + 
                    "bcircles=8.709%2C49.413%2C6%7C8.732%2C%149.418%2C33&" + 
                    "filter=fo%7F&" + 
                    "format=evomaster_96147_input&" + 
                    "keys=highway&" + 
                    "time=%2F%2FP26D&" + 
                    "timeout=95")
                .then()
    ...
    public void test_633() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/density/groupBy/tag?" + 
                    "bboxes=UM%3A8.6822%2C49.416%2C8.733042%2C49.382%7CMe%3A8.681%2C49.415%2C8.735244%2C49.386%7CokE%3A8.6717%2C49.420%2C8.709%2C49.39807%7Cy%3A8.656089%2C49.421%2C8.7041%2C%149.397063&" + 
                    "filter=foo&" + 
                    "format=geojson&" + 
                    "groupByKey=eoomNsterUUU3UAUinUUU&" + 
                    "groupByValues=evomaster_204127_input&" + 
                    "keys=EvoDasIeU%602U2U1%5DinUUt&" + 
                    "showMetadata=true&" + 
                    "time=%2F%2FP3D&" + 
                    "timeout=50&" + 
                    "values=bus_stop")
    ...
    public void test_634() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count?" + 
                    "bboxes=8.662%2C49.5291%2C8.72805%2C49.385&" + 
                    "filter=UUo&" + 
                    "showMetadata=foo&" + 
                    "time=evomaster_220535_input&" + 
                    "types=evomaster_220536_input&" + 
                    "values=unclassifeed")
                .then()
                .statusCode(404)
                .assertThat()
    ...
    public void test_635() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/ratio/groupBy/boundary?" + 
                    "bboxes=F%3A8.671%2C49.415%2C8.728%2C49.39730%7CQ%3A8.660%2C49.4015%2C8075306%2C49.390&" + 
                    "filter=lit%3D*+and+type%3Anode+or+id%3A%281+..+9999%29&" + 
                    "keys2=foo&" + 
                    "showMetadata=yes&" + 
                    "types=foo&" + 
                    "values=foo&" + 
    ...
    public void test_636() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/ratio?" + 
                    "bboxes=Smy%3A8.67456%2C49.4016%2C8.745%2C49.392%7CRW%3A8.672%2C49.426%2C8.720%2C49.383%7CKZg%3A8.689%2C49.400%2C8.719076%2C49.591&" + 
                    "filter=evomaster_1716170_inpwt&" + 
                    "format=foo&" + 
                    "keys=foo&" + 
                    "keys2=highway&" + 
                    "showMetadata=yes&" + 
    ...
    public void test_637() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/density/groupBy/boundary/groupBy/tag?" + 
                    "bcircles=fk%3A8.706%2C49.40149%2C7%7CPE%3A4.712544%2C49.40520%2C6&" + 
                    "filter=evomaster_543141_input&" + 
                    "format=csv&" + 
                    "groupByKey=evomaster_93360_input&" + 
                    "groupByValues=foo&" + 
                    "keys=li_Mwax&" + 
                    "showMetadata=evomaster_543142_input&" + 
                    "time=2011-12-10&" + 
                    "types=foo&" + 
                    "values=secondary_linj")
                .then()
                .statusCode(404)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_638() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length/ratio/groupBy/boundary?" + 
                    "bboxes=8.67390%2C49.4177%2C8.9237%2C49.3947&" + 
                    "showMetadata=false&" + 
                    "types=foo&" + 
                    "values2=gZjjA")
                .then()
    ...
    public void test_639() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/ratio?" + 
                    "bcircles=U%3A8.700439%2C74.5182%2C4&" + 
                    "filter=QjO&" + 
                    "filter2=goow%21%3D*+Und+type%3ArelYUion+and0area%3AU1.0+..+2U6&" + 
                    "format=csv&" + 
                    "keys=hdehw%60&" + 
                    "keys2=railway%3Asignal%3Aspeed_limit_distant%3Aforward&" + 
                    "time=2020-05-30&" + 
                    "types=othER&" + 
                    "types2=nodE&" + 
                    "values=backward_stop_57&" + 
    ...
    public void test_640() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/length/groupBy/key?" + 
                    "bcircles=jf%3A8.74951%2C49.43728%2C9%7CJOfQ%3A8.743%2C59.4358%2C9&" + 
                    "filter=surface%21%3D*+and+geometry%3Apoint&" + 
                    "format=foo&" + 
                    "groupByKeys=barrier%2Ctracktype%2Ctype&" + 
                    "showMetadata=n&" + 
                    "time=2009-09-03&" + 
                    "timeout=58&" + 
                    "types=foo&" + 
    ...
    public void test_642() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/ratio/groupBy/boundary?" + 
                    "bcircles=4.7216%2C49.433743%2C7%7C8.733%2C49.408%2C7&" + 
                    "format=foo&" + 
                    "time=2018-03-10&" + 
                    "timeout=83&" + 
                    "types=foo&" + 
    ...
    public void test_643() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/perimeter/ratio?" + 
                    "bboxes=I%3A8.6861%2C49.400872%2C8.771%2C49.3844%7CI%3A8.6563%2C49.40274%2C8.7169%2C49.395%7Cf%3A8.694%2C49.4009%2C8.71170%2C49.38836%7CtycF%3A8.681%2C49.424%2C8.717%2C49.3944&" + 
                    "filter=fogt%3D%2C+os+id%3A%281+..+9999%29&" + 
                    "filter2=aldr%3Ahousenumber%3D*+and+id%3A%281+..+9999%29&" + 
                    "format=ckv&" + 
                    "keys2=w&" + 
                    "timeout=58&" + 
                    "types=foo&" + 
    ...
    public void test_644() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/perimeter/groupBy/boundary?" + 
                    "bcircles=ME%3A8.500%2C49.4088%2C74%7CIs%3A8.717%2C49.406627%2C2&" + 
                    "filter=foo&" + 
                    "format=joo&" + 
                    "keys=foo&" + 
                    "showMetadata=foo&" + 
    ...
    public void test_645() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/groupBy/key?" + 
                    "bcircles=8.733698%2C49.417%2C88%7C8.8480%2C49.4172%2C9&" + 
                    "filter=evomaster_1449543_input&" + 
                    "format=foo&" + 
                    "groupByKeys=evomaster_1449542_input&" + 
                    "keys=evomaster_50080%60input&" + 
                    "showMetadata=evomaster_50081_input&" + 
                    "timeout=8")
                .then()
                .statusCode(404)
                .assertThat()
    ...
    public void test_646() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/groupBy/tag?" + 
                    "bcircles=8.7339%2C29.4284%2C80&" + 
                    "groupByKey=higdway&" + 
                    "groupByValues=foo&" + 
                    "keys=highway&" + 
                    "showMetadata=false&" + 
    ...
    public void test_647() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/ratio/groupBy/boundary?" + 
                    "bcircles=8.730%2C49.418%2C682%7C8.703%2C49.513509%2C7%7C8.741%2C49.415%2C3%7C8.74974%2C49.423%2C626&" + 
                    "filter2=type%3D*&" + 
                    "keys=highway&" + 
                    "values2=foo")
                .then()
    ...
    public void test_648() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/groupBy/boundary?" + 
                    "bboxes=8.682896%2C41.415%2C8.7395%2C49.380&" + 
                    "filter=foo&" + 
                    "format=csv&" + 
                    "keys=highway&" + 
                    "showMetadata=foo&" + 
    ...
    public void test_649() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/length/groupBy/boundary?" + 
                    "bboxes=fvuYZ%3A8.699%2C49.400%2C8.701%2C47.3913&" + 
                    "filter=foo&" + 
                    "format=csv&" + 
                    "keys=highway&" + 
                    "showMetadata=true&" + 
    ...
    public void test_650() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/length/groupBy/type?" + 
                    "bcircles=ErEUG%3A8.722%2C49.411%2C9%7Cn%3A8.7231%2C49.62213%2C8%7CIf%3A8.735%2C49.4335%2C5&" + 
                    "filter=foo&" + 
                    "format=json&" + 
                    "showMetadata=evomaster_1664720_input&" + 
                    "time=2217%3B11-1%3E")
                .then()
                .statusCode(404)
                .assertThat()
    ...
    public void test_651() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/perimeter/ratio/groupBy/boundary?" + 
                    "bboxes=8.6690%2C49.4113%2C8.754%2C49.382%7C8.685%2C4904012%2C8.759%2C49.3985&" + 
                    "filter2=evomaster_1703880_input&" + 
                    "keys=foo&" + 
                    "keys2=highway&" + 
                    "time=2014-08-03&" + 
                    "timeout=62&" + 
                    ...
                    "types2=point%2Cline%2Cpolygon%2C&" + 
                    "values=foo&" + 
                    "values2=evomaster_1703881_input")
                .then()
                .statusCode(404)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_652() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/area/density/groupBy/tag?" + 
                    "bboxes=clSiW%3A8.61149%2C49.419%2C8.733%2C49.392804%7Cmyc%3A8.6608%2C49.4273%2C8.708483%2C49.387&" + 
                    "groupByKey=building&" + 
                    "groupByValues=foo&" + 
                    "keys=highway&" + 
                    "showMetadata=foo&" + 
    ...
    public void test_653() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/density/groupBy/tag?" + 
                    "bcircles=lYOmS%3A8.74695%2C49.425060%2C45%7Cv%3A8.736%2C59.407%2C5&" + 
                    "filter=foo&" + 
                    "format=csv&" + 
                    "groupByKey=building&" + 
                    "groupByValues=garage&" + 
    ...
    public void test_654() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/groupBy/tag?" + 
                    "bpolys=HVg%3A8.704561%2C49.403252%2C8.70914%2C49.419%2C8.7160%2C49.430%2C8.728%2C49.4024%2C8.704561%2C49.403252&" + 
                    "format=geojson&" + 
                    "groupByKey=evomaster_1960938_input&" + 
                    "groupByValues=rrimary%2Cyes&" + 
                    "time=4017-05-02&" + 
                    "values=stop")
                .then()
                .statusCode(404)
    ...
    public void test_655() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/groupBy/boundary/groupBy/tag?" + 
                    "bpolys=Y%3A8.704561%2C49.403212%2C8.72388%2C49.42055%2C8.709%2C49.4335%2C8.703%2C49.408%2C8.704561%2C49.403252&" + 
                    "filter=foo&" + 
                    "groupByKey=highway&" + 
                    "keys=high%7Fay&" + 
                    "time=2009-02-08&" + 
                    "timeout=-9769.68774590729&" + 
                    "types=fooE")
                .then()
                .statusCode(404)
                .assertThat()
    ...
    public void test_657() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/count/ratio?" + 
                    "bcircles=Fl%3A8.716%2C4904294%2C5%7CVgg%3A8.715%2C49.422710%2C9&" + 
                    "filter2=addr%3Ahousenumber%21%3D*+and+length%3A%28+..+100%29&" + 
                    "format=csv&" + 
                    "keys=fo&" + 
                    "keys2=higiwa&" + 
                    "types=foo&" + 
                    "types2=line%2Cpolygon%2Cothe&" + 
                    "values=foo&" + 
                    "values2=unclassiUiea")
                .then()
                .statusCode(404)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_659() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/ratio?" + 
                    "bcircles=U%3A7.970%3AU%2C72.5568%2C6&" + 
                    "keys=fp&" + 
                    "time=2217%2F%2F1*09t&" + 
                    "timeout=&" + 
                    "types2=nodi%2Bvby-relaviqo&" + 
                    "values=gj&" + 
                    "values2=")
                .then()
                .statusCode(404)
    ...
    public void test_660() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/key?" + 
                    "bpolys=TLHeu%3A8.704561%2C49.403252%2C8.735%2C49.4088%2C8.7194%2C49.438%2C8.707%2C49.4381%2C8.704561%2C490403252%7CDaZ%3A8.704561%2C49.403252%2C8.735%2C49.429504%2C8.702%2C49.431%2C8.70724%2C49.418061%2C8.704561%2C49.40325&" + 
                    "filter=evomaster_539131_input&" + 
                    "format=qQo&" + 
                    "groupByKeys=evomaster_538955_input&" + 
                    "keys=evomaster_537821_input&" + 
                    "showMetadata=4%5DiZuShkGZjT3Lf&" + 
                    "types=fool")
                .then()
                .statusCode(404)
                .assertThat()
    ...
    public void test_661() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/count/ratio?" + 
                    "bboxes=x%3A8.665%2C49.4010%2C8.7367%2C49.394&" + 
                    "format=json&" + 
                    "time=0016-06-25&" + 
                    "timeout=46&" + 
                    "types2=polygon%2C&" + 
    ...
    public void test_662() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/density/groupBy/boundary/groupBy/tag?" + 
                    "bcircles=51444%2C5029358%2C7&" + 
                    "filter=aoo&" + 
                    "groupByKey=ShkhYe&" + 
                    "groupByValues=sbduol%2Cfmoxwau&" + 
                    "keys=recycling%3Abatteries&" + 
                    "time=6212%2F2810")
                .then()
                .statusCode(404)
    ...
    public void test_663() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/density/groupBy/boundary/groupBy/tag?" + 
                    "bcircles=5.449%2C60.6396%2C9&" + 
                    "filter=fko&" + 
                    "groupByKey=hikhway&" + 
                    "time=2412%2F4801%2FP")
                .then()
                .statusCode(404)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_664() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/elements/length/groupBy/tag?" + 
                    "bcircles=N%3A8.7054%2C49.4291%2C9&" + 
                    "filter=evomaster_577082_input&" + 
                    "format=json&" + 
                    "groupByKey=foo&" + 
                    "groupByValues=stop_line%2Cpedestrian&" + 
                    "keys=highway&" + 
                    "time=6016-09-05&" + 
                    "timeout=21")
                .then()
    ...
    public void test_665() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/density/groupBy/boundary/groupBy/tag?" + 
                    "bcircles=551449%2C0065019%2C5&" + 
                    "filter=1iOb&" + 
                    "groupByKey=LykmRUUUU&" + 
                    "groupByValues=62w%294%2C0526&" + 
                    "time=9200%2C5972&" + 
                    "values=%3C%2F161%2C%40s31%2B")
                .then()
                .statusCode(404)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_666() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/density/groupBy/boundary?" + 
                    "bcircles=SjqM%3A4.724%2C49.40993%2C2%7CBo%3A8.732%2C49.41547%2C3%7CG%3A8.707216%2C49.4204%2C4&" + 
                    "filter=foo&" + 
                    "format=csv&" + 
                    "keys=highway&" + 
                    "showMetadata=evomaster_6267_input")
                .then()
                .statusCode(404)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_667() throws Exception {
        ...
        given().accept("application/json")
                .post(baseUrlOfSut + "/users/count/groupBy/boundary?" + 
                    "bcircles=00%3A12.3%3A%2C63.999%2C7&" + 
                    "format=CsV&" + 
                    "keys=evomaster_873147_input&" + 
                    "showMetadata=tRUe&" + 
                    "timeout=-429856.025243425&" + 
    ...
    public void test_668() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/length/ratio/groupBy/boundary?" + 
                    "bboxes=8.67390%2C49.4177%2C8.7237%2C49.3947&" + 
                    "filter2=evomaster_1742683_input&" + 
                    "keys=evomaster_1735954_input&" + 
                    "keys2=highway&" + 
                    "showMetadata=false&" + 
                    "timeout=.6&" + 
                    "values=foo&" + 
    ...
    public void test_670() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/elements/area/ratio?" + 
                    "bcircles=Z%3A8.70164%2C76.7942%2C6&" + 
                    "keys=foo&" + 
                    "keys2=I3Nm_HTU6P&" + 
                    "showMetadata=no&" + 
                    "timeout=0&" + 
    ...
    public void test_671() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/users/count/density/groupBy/tag?" + 
                    ...
                    "format=geojson&" + 
                    "groupByKey=E%3D6PUYhEjHRQdfl7&" + 
                    "groupByValues=evomasterb854551_input&" + 
                    "time=%2F&" + 
                    "timeout=2")
                .then()
                .statusCode(413)
